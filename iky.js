...
antilink.push(from)
 ...
 return sendButMessage(from, `ANTILINK NYA KAK`, `ping  ${latensie.toFixed(4)} sec\nRuntime: ${runtime(process.uptime())}`, [
            {
               "buttonId": noprefix ? "antilink enable" : "!"+"antilink enable",
               "buttonText": {
            ...
            {
               "buttonId": noprefix ? "antilink disable" : "!"+"antilink disable",
               "buttonText": {
...
return sendButMessage(from, `WELCOME NYA KAK`, `ping  ${latensie.toFixed(4)} sec\nRuntime: ${runtime(process.uptime())}`, [
            {
               "buttonId": noprefix ? "welcome enable" : "!"+"welcome enable",
               "buttonText": {
            ...
            {
               "buttonId": noprefix ? "welcome disable" : "!"+"welcome disable",
               "buttonText": {
