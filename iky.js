...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentaisearch?apikey=PunyaIkyAds&query=${budy}`)
...
if (tebakanime.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebakchara?apikey=IkyAdss`)
get_result = get_result.result
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/siapaaku?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/kata?apikey=IkyAdss`)
 get_result = get_result.result
 jawaban = get_result.jawaban
...
if (tebaklirik.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/lirik?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/jenaka?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
  pertanyaan = get_result.question
...
get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/unsurkimia?apikey=IkyAdss`)
 get_result = get_result.result
...
if (tebakbendera.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/bendera?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.name
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/susunkata?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.jawaban
  pertanyaan = get_result.pertanyaan
...
get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/asahotak?apikey=IkyAdss`)
 get_result = get_result.result
 jawaban = get_result.jawaban
 kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
 pertanyaan = get_result.pertanyaan
...
if (caklontong.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`http://Api.lolhuman.xyz/api/tebak/caklontong2?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
🐤 Character : ${get_info.characters.join(", ")}\n`
      ...
      case 'kusonime':
       ...
       case 'storyanime':
              ...
              reply(mess.wait)
              anu = await fetchJson(`http://Api.lolhuman.xyz/api/storynime?apikey=IkyAdss`)
...
if (!isGroup) return reply(mess.only.group)
 ...
 profilePic = errorImg
  ...
  buffer = await getBuffer(`http://Api.lolhuman.xyz/api/rank?apikey=IkyAdss&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
case 'sc': 
case 'src':
fakestatus(`SC? NI ADA YANG ENC WKWK`)
break
case 'ping':
case 'speed':
timestampe = speed();
latensie = speed() - timestampe
fakestatus(`「 *WANN BOTZ* 」\nMerespon dalam ${latensie.toFixed(4)} Sec 💬`)
break
case 'botstat':
groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
