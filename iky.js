...
let ikyads = await getBuffer(`https://telegra.ph/file/3c777b1f32290b2359b54.jpg`)
...
case 'iklan':
      ...
      gopeynya = 'https://j.top4top.io/p_2093b2q3j1.jpg'
...
│❏  🪀 wa.me/6285640068416?text=sewa+bot

╰────

╭─[ *TES BOT? MASUK GRUB DI BAWAH* ]

│❏https://chat.whatsapp.com/CM1Tf9nxqpzL7sIYZil65T
...
WAKTU        : ${time2}
  ...
  *TERIMA KASIH TELAH ORDER*
          ...
          break
              ...
              gopeynya = `Halo Kak ${pushname} BERIKUT ADALAH LIST DIAMOND FF
...
${timuu} WIB`
  ...
  ikyy.sendMessage(from, { contentText: `${gopeynya}`, footerText: `${buff}`, buttons: [{ buttonId: `!iklan`, buttonText: { displayText: 'SEWA BOT' }, type: 1 },{ buttonId: `!payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
       ...
       case 'patrick':
             ...
             .then(body => {
              ...
              dpuhy = args.join(' ')
                ...
                dapuhy = await getBuffer(`https://api.lolhuman.xyz/api/amongus?apikey=ZUFAR&text=${dpuhy}`)

                ikyy.sendMessage(from, dapuhy, sticker, {quoted: freply})
...
//------------------< Ingfo Bot >-------------------
      ...
      case 'runtime':
       ...
       case 'src':
              ...
              textImg(`SC? GA ADA MAU COPAS AJA KERJAANNYA`)
...
//------------------< Lainnya >-------------------
 ...
 buttons = [{buttonId: ".menu",buttonText:{displayText: 'BACK TO MENU'},type:1},{buttonId: ".owner", buttonText:{displayText:'👤OWNER BOT'},type:1},{buttonId: ".infoig",buttonText:{displayText: 'INFO OWNER'},type:1}]
