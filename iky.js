...
case 'allmenu2':
        ikyy.sendMessage(from, allmenu(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
case 'allmenu':
 thu = await ikyy.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
...
mute.push(from)
 ...
 reply(`Pilih enable atau disable`)
  ...
  case 'buggc1':
        ikyy.sendMessage(from, virtex90(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc2':
        ikyy.sendMessage(from, virtex2(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc3':
        ikyy.sendMessage(from, virtex3(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc4':
        ikyy.sendMessage(from, virtex4(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
case 'buggc5':
        ikyy.sendMessage(from, virtex5(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
case 'buggc6':
        ikyy.sendMessage(from, virtex6(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc7':
        ikyy.sendMessage(from, virtex7(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc8':
        ikyy.sendMessage(from, virtex8(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc9':
        ikyy.sendMessage(from, virtex9(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc10':
        ikyy.sendMessage(from, ngazap(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc11':
        ikyy.sendMessage(from, virtag(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
        case 'buggc12':
        ikyy.sendMessage(from, emoji2(prefix), text, {quoted: ftoko, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})
        break
