...
if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
 ...
 reply(`*「 GROUP LINK DETECTOR 」*\n\n Sampah Lu Masuk Grup Cuma Mau Kirim Link Grup,Gwe Kick Lah!`)
...
tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI WANN BOTZ`
ind = {
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentai/${budy}?apikey=IkyAdssIkyAdssIkyAdss`)
...
var pdf = await axios.get(`https://api.lolhuman.xyz/api/nhentaipdf/${budy}?apikey=IkyAdss`)
...
if (body.match(/^[0-9]/)) return reply("Reply with number!")
  reply("Wait a moment, the data is being processed")
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentai/${budy}?apikey=IkyAdss`)
...
var a = await axios.get(`https://api.lolhuman.xyz/api/nhentaisearch?apikey=IkyAdss&query=${budy}`)
...
headerType: 1
 ...
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: 'BACK TO MENU'},type:1},{buttonId:noprefix ? "runtime" : "!"+"runtime", buttonText:{displayText:'RUNTIME'},type:1},{buttonId: noprefix ? "speed" : "!"+"speed",buttonText:{displayText: 'SPEED'},type:1}]
 buttonsMessage = {
contentText: `${txtt}`,
...
if (!isPremium) return reply(`khusus premium`)
 ...
 try {
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=IkyAdss&nomor=${args[1]}`)
await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=IkyAdss&nomor=${args[1]}`)
reply("Success")
 } catch (err) {
sendMess(ownerNumber, `${command} Error:` + err)
reply(mess.error.api)
...
menu =`${botName}
 ...
 __  __    _    _   _ _   _ _____    ____ _   _ ____ _____ ___ 
   |  \/  |  / \  | \ | | | | |_   _|  / ___| | | / ___|_   _|_ _|
 | |\/| | / _ \ |  \| | | | | | |   | |  _| | | \___ \ | |  | | 
  | |  | |/ ___ \| |\  | |_| | | |   | |_| | |_| |___) || |  | | 
|_|  |_/_/   \_\_| \_|\___/  |_|    \____|\___/|____/ |_| |___|
...
reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
 ...
 buff = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=IkyAdss`, {method: 'get'})
...
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=IkyAdss`)
...
case 'nsfw_avatar':
reply (mess.wait)
buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=IkyAdss`)
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
contentText:`©WhatsApp bot`,buttons,headerType:4}
...
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=IkyAdss&text=${ini_txt}`)
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=IkyAdss&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=IkyAdss&text=${ini_txt}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
...
txt1 = args[0]
 txt2 = args[1]
 buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=IkyAdss&text1=${txt1}&text2=${txt2}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
ini_txt = args.join(" ")
 buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=IkyAdss&text=${ini_txt}`)
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: `BACK MENU`},type:1}]
 imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
 buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
 contentText:`©WhatsApp bot`,buttons,headerType:4}
...
if (banChats === true) return
 uptime = process.uptime()
  ...
  break
  case 'quotes':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=IkyAdss`)
  ...
  break
  case 'quotesanime':
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=IkyAdss`)
  quotes = quotes.result
  quote = quotes.quote
  ...
  break
  case 'quotesdilan':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=IkyAdss`)
  reply(get_result.result)

  break
  break
  case 'quotesimage':
  buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=IkyAdss`)
  buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
  imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
  ...
  case 'pantun':
  case 'bucin':
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=IkyAdss`)
...
type: 1,
  ...
  break
  case 'randomnama':
  anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=IkyAdss`)
  kyyi = anu.result
...
type: 1,
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Transformer`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=IkyAdss&query=${query}`)
...
break
case 'drakorongoing':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=IkyAdss`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://www.wattpad.com/707367860-kumpuLan-quote-tere-liye-tere-liye-quote-quote`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=IkyAdss&url=${ini_url}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Rating : ${get_result.rating}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} Tere Liye`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=IkyAdss&query=${query}`)
get_result = get_result.result
...
break
case 'cerpen':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=IkyAdss`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
...
break
case 'ceritahoror':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=IkyAdss`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Desc : ${get_result.desc}\n`
ini_txt += `Story :\n${get_result.story}\n`
...
// Islami //
case 'listsurah':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=IkyAdss`)
get_result = get_result.result
ini_txt = 'List Surah:\n'
...
if (args.length < 1) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10 or ${prefix + command} 18/1-10`)
  urls = `https://api.lolhuman.xyz/api/quran/${args[0]}?apikey=IkyAdss`
...
if (args.length == 0) return reply(`Example: ${prefix + command} 18 or ${prefix + command} 18/10`)
  surah = args[0]
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=IkyAdss`)
await ikyy.sendMessage(from, ini_buffer, audio, { quoted: freply, mimetype: Mimetype.mp4Audio })
break
case 'asmaulhusna':
get_result = await fetchJson(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=IkyAdss`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Muhammad`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=IkyAdss`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Yogyakarta`)
  daerah = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=IkyAdss`)
get_result = get_result.result
...
anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=IkyAdss`)
...
if (tebakanime.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=IkyAdss`)
get_result = get_result.result
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=IkyAdss`)
 get_result = get_result.result
 jawaban = get_result.jawaban
...
if (tebaklirik.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.answer
  kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
  pertanyaan = get_result.question
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=IkyAdss`)
 get_result = get_result.result
...
if (tebakbendera.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.name
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
if (isGame(sender, isPremium, gcount, glimit)) return reply(`Limit game kamu sudah habis`)
 ...
 get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=IkyAdss`)
  get_result = get_result.result
  jawaban = get_result.jawaban
  pertanyaan = get_result.pertanyaan
...
get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=IkyAdss`)
 get_result = get_result.result
 jawaban = get_result.jawaban
 kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
 pertanyaan = get_result.pertanyaan
...
if (caklontong.hasOwnProperty(sender.split('@')[0])) return reply("Masih ada soal yg belum terjawab")
  get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=IkyAdss`)
get_result = get_result.result
jawaban = get_result.answer
kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
pertanyaan = get_result.question
...
setTimeout( () => {
 ikyy.updatePresence(from, Presence.composing)
 reply(` *Terimakasih Telah Terdaftar Di「 Wann Botz 」*`)
  }, 2000)
break
case 'sfire1':{
...
reply(mess.success)
 ...
 txt += `➸ *ID :* @${i.id.split("@")[0]}\n➸ *Expired*: ${checkExp.days} day(s) ${checkExp.hours} hour(s) ${checkExp.minutes} minute(s)\n\n`
  ...
  ┗━━⬣
  `
  buttons = [{buttonId: noprefix ? "owner" : "!"+"owner",buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
  imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'follow @achyrr_wann', imageMessage: imageMsg,
  ...
  break
  case 'dana':
  gopeynya = `https://instabio.cc/wannstore`
  buff = await getBuffer(gopeynya)
  teksnya = `
  Hai kak ${pushname}
...
reply(mess.wait)
 anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=IkyAdss&url=${q}`)
...
try {
  henid = args[0]
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=IkyAdss`)
  get_result = get_result.result
  ...
  reply(mess.wait)
  anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=IkyAdss`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
 reply(mess.wait)
  query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=IkyAdss&query=${query}`)
  get_result = get_result.result
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=IkyAdss&query=${query}`)
 get_result = get_result.result
 ini_txt = `Id : ${get_result.id}\n`
 ini_txt += `Id MAL : ${get_result.idMal}\n`
 ini_txt += `Title : ${get_result.title.romaji}\n`
...
reply(mess.wait)
 query = args.join(" ")
 get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=IkyAdss&query=${query}`)
 get_result = get_result.result
 ini_txt = `Title : ${get_result.title}\n`
...
for (var y in link_dl[x]) {
 ...
 if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
  reply(mess.wait)
query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=IkyAdss&query=${query}`)
get_result = get_result.result
ini_txt = `Title : ${get_result.title}\n`
ini_txt += `Japanese : ${get_result.japanese}\n`
...
if (args.length == 0) return reply(`Example: ${prefix + command} https://nekopoi.care/isekai-harem-monogatari-episode-4-subtitle-indonesia/`)
  ini_url = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=IkyAdss&url=${ini_url}`)
get_result = get_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} Isekai Harem`)
  query = args.join(" ")
get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=IkyAdss&query=${query}`)
get_result = get_result.result
ini_txt = ""
for (var x of get_result) {
  ini_txt += `\`\`\`🐥 Title : ${x.title}\`\`\`\n`
...
reply(mess.wait)
anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=IkyAdss`)
...
*[Wait] Tunggu Sebentar..*`
 ...
 query = args.join(" ")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/lirik?apikey=IkyAdss&query=${query}`)
  reply(get_result.result)
 ...
 query = args.join(" ")
  reply (mess.wait)
  ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=IkyAdss&query=${query}`)
...
if (!isGroup) return reply(mess.only.group)
 ...
 profilePic = errorImg
  ...
  buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=IkyAdss&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} ikyy-chan02`)
  reply(mess.wait)
username = args[0]
ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=IkyAdss`)
...
if (args.length == 0) return reply(`Example: ${prefix + command} ikyy.chan26`)
 reply(mess.wait)
username = args[0]
ini_result = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${username}?apikey=IkyAdss`)
ini_result = ini_result.result
...
if (args.length == 0) return reply(`Example: ${prefix + command} marz.hiatus`)
 reply(mess.wait)
stalk_toktok = args[0]
get_result = await fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${stalk_toktok}?apikey=IkyAdss`)
get_result = get_result.result
...
//------------------< Sticker/Tools >-------------------
 ...
 if (!q) return reply(`Example: ${prefix + command} https://t.me/addstickers/LINE_Menhera_chan_ENG`)
  reply(mess.wait)
ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=IkyAdss&url=${args[0]}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=IkyAdss`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji3/${emoji}?apikey=IkyAdss`)
await ikyy.sendMessage(from, ini_buffer, sticker, { quoted: freply })
case 'ttp':
case 'ttp2':
case 'ttp3':
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = await getBuffer (`https://api.zeks.xyz/api/burning-image?apikey=IkyAdss&image=${tolink}`)
...
pjr = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=IkyAdss&image${encodeURI(tolink)}`)
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = `https://api.lolhuman.xyz/api/editor/triggered?apikey=IkyAdss&img=${tolink}`
sendStickerUrl(from, `${anu1}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/triggered?apikey=IkyAdss&img=${ini_url}`)
...
if (isImage || isQuotedImage) {
  ...
  let ane = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=IkyAdss&image=${tolink}`)
...
if (isImage || isQuotedImage) {
 ...
 ranp = getRandom('.gif')
 rano = getRandom('.webp')
 var ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=IkyAdss&img=${tolink}`
...
if (args.length < 2) return 
 let ane = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=IkyAdss&text=${mek}`)
...
case 'sc': 
case 'src':
textImg(`SC OM ? DI YT WKWK`)
break
case 'ping':
case 'speed':
timestampe = speed();
latensie = speed() - timestampe
fakeitem(`「 *WANN BOTZ* 」\nBot Merespon dalam ${latensie.toFixed(4)} Sec 💬`)
break
case 'botstat':
groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
...
if (budy.includes(`wan`)) {
  reply(`Iya kenapa manggil ownerku?Owner ku lagi sibuk`)
}
...
if (budy.includes(`bot`)) {
  reply(`Ya Saya Userbot Nama Owner saya ${ownerName}`)
}
