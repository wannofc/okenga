...
let ikyads = await getBuffer(`https://telegra.ph/file/8a5199e962f9ee39f496f.jpg`)
fakelink = (tekslink) => { 
...
ikyy.sendMessage(from, { contentText: `${menu}`, footerText: `${wibu}`, buttons: [{ buttonId: `!command`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },{ buttonId: `!iklan`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
   ...
   case 'command':
               ...
               listmsg(from, `G a n t　Ｂｏｔｚ ぽ `,`  `, list)
               break
...
case 'iklan':
      gopeynya = 'https://a.top4top.io/p_2109h33hx0.jpg'
     teksnya = `
╭──「🇸 🇪 🇼 🇦  🇧 🇴 🇹 」
...
╰────
╭─[ *MINAT CHAT* ]
│❏  🪀 https://wa.me/6282192943105?text=sewa+bot+bang
╰────
╭─[ *TES BOT? MASUK GRUB DI BAWAH* ]
│❏https://chat.whatsapp.com/IoB4bdCatSQLtOO3cPWi6C
╰────
╭─[ *PAYMENT* ]
│❏  GOPAY
│❏  DANA
...
WAKTU        : ${time2}
  ...
  *TERIMA KASIH TELAH ORDER*
          ...
          break
				...
				case 'sewabot':
              gopeynya = `Halo Kak ${pushname} Berikut List Sewa Bot by GANT STORE 
...
case 'dana':
              ...
              gopeynya = 'https://l.top4top.io/p_2109y2ihp0.jpg'
     teksnya = `
${ucapanWaktu} Kak ${pushname}
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Follow @gantod`},type:1}]
...
//------------------< Menunya Bang:v >-------------------
      case 'don':
             ...
             break
      case 'infoig':
             reply('https://instabio.cc/gantod')
             break
      case 'gc':
      reply('https://instabio.cc/gantod')
      break
