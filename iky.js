...
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`media/odc.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`TERIMA KASIH TELAH SEWA BOT DI WANNI STORE`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
...
key:{
          fromMe:false, 
participant: `0@s.whatsapp.net`, ...(from ? { 
remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "WANN BOTZ", 'jpegThumbnail': fs.readFileSync(`media/odc.jpeg`)}}}})
...
© ›› W a n n B o t z
`
                    ikyy.sendMessage(from, { contentText: `${menu}`, buttons: [{ buttonId: `!command`, buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '👥 OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
ikyy.sendMessage(from, { contentText: `${menu}`, footerText: `${wibu}`, buttons: [{ buttonId: `!command`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },{ buttonId: `!iklan`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
   ...
   case 'command':
               ...
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`Sound Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Group WANN BOTZ🇮🇩`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
WAKTU        : ${time2}
  ...
  *TERIMA KASIH TELAH ORDER*
  ...
  ┗━━⬣
  `
buttons = [{buttonId: "!owner",buttonText:{displayText: `OWNER`},type:1},{buttonId: "!payment",buttonText:{displayText: `PAYMENT`},type:1}]
...
case 'chiisaihentai':
              ...
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by WANN BOTZ', imageMessage: imageMsg,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              fakegroup(`${runtime(process.uptime())}`)
              break
       case 'donate': 
       case 'donasi':
              fakegroup(setting.txtDonasi)
              break
       case 'sourcecode': 
       case 'sc': 
       case 'src':
      ...
      case 'speed':
              timestampe = speed();
              latensie = speed() - timestampe
              fakestatus(`「 *WANN BOTZ* 」\nMerespon Seperti Kecepatan Rossi Balapan ${latensie.toFixed(4)} Sec 💬`)
              break
      case 'botstat':
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
