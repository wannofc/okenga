...
if (banChats === true) return
 ...
 uptime = process.uptime()
  ...
  quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=IkyChan`)
  ...
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=IkyChan`)
