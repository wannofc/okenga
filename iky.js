...
You can see other menus for yourself by typing !command`
 ...
 case 'help':
 case 'menu':
					contentd1 = fs.readFileSync(`./media/image.jpeg`)
					ikyy.sendMessage(from, contentd1,image,{				
                    quoted: ftroli,caption:menu(prefix),contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hiii ${pushname}`,body:"",mediaType:"2",thumbnail:thumbnail,mediaUrl:`https://youtu.be/t1SMu5MYMAE`}}})
					break
menu =`${botName}
