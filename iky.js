...
case 'tes':
 ...
 buttons = [{buttonId: noprefix ? "menu" : "!"+"menu",buttonText:{displayText: 'BACK TO MENU'},type:1},{buttonId:noprefix ? "runtime" : "!"+"runtime", buttonText:{displayText:'RUNTIME'},type:1},{buttonId: noprefix ? "speed" : "!"+"speed",buttonText:{displayText: 'BACK TO MENU'},type:1}]
 buttonsMessage = {
contentText: `${txtt}`,
footerText: 'Jangan Sungkan Chat Ya Kak',
buttons: buttons,
