...
You can see other menus for yourself by typing !command`
 ...
 case 'menu':
                    ...
                    quoted: freply,caption:menu(prefix),contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hiii ${pushname}`,body:"",mediaType:"2",thumbnail:thumbnail,mediaUrl:`https://youtu.be/t1SMu5MYMAE`}}})
					break
menu =`${botName}
